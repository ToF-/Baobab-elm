var Elm = Elm || { Native: {} };
Elm.Baobab = Elm.Baobab || {};
Elm.Baobab.make = function (_elm) {
   "use strict";
   _elm.Baobab = _elm.Baobab || {};
   if (_elm.Baobab.values)
   ...
   var translate = F2(function (_v0,
   pts) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var translatePoint = F2(function (_v4,
                 _v5) {
                    return function () {
                       switch (_v5.ctor)
                       {case "_Tuple2":
   ...
   pts) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var rotatePoint = F3(function (_v16,
                 phi,
                 _v17) {
                    return function () {
                       switch (_v17.ctor)
                          ...
                          return function () {
                               ...
                               {case "_Tuple2":
                                  return function () {
                                       ...
                                       var dx = _v16._0 - _v16._0 * cosPhi + _v16._1 * sinPhi;
                                       var dy = _v16._1 - _v16._0 * sinPhi - _v16._1 * cosPhi;
                                       return {ctor: "_Tuple2"
                                              ,_0: _v17._0 * cosPhi - _v17._1 * sinPhi + dx
   ...
   var baselessTriangle = F3(function (_v37,
   l,
   phi) {
      return function () {
         switch (_v37.ctor)
         {case "_Tuple2":
            return _L.fromArray([{ctor: "_Tuple2"
                                 ...
                                 ,_1: _v37._1}
                                ,{ctor: "_Tuple2"
                                 ,_0: _v37._0 + l * $Basics.cos(phi)
                                 ,_1: _v37._1 + l * $Basics.sin(phi)}
                                ,{ctor: "_Tuple2"
                                 ,_0: _v37._0 + l
                                 ,_1: _v37._1}]);}
         _U.badCase($moduleName,
         "on line 17, column 32 to 82");
      }();
   });
   var baselessSquare = F2(function (_v41,
   l) {
      return function () {
         switch (_v41.ctor)
         {case "_Tuple2":
            return _L.fromArray([{ctor: "_Tuple2"
                                ...
                                ,{ctor: "_Tuple2"
                                 ...
                                 ,_1: _v41._1}]);}
         _U.badCase($moduleName,
         "on line 14, column 26 to 59");
      }();
   });
   _elm.Baobab.values = {_op: _op
                        ,baselessSquare: baselessSquare
                        ,baselessTriangle: baselessTriangle
                        ,baobab: baobab
...
Elm.ElmTest.Runner.Element.make = function (_elm) {
   ...
   var plainText = function (s) {
      return $Text.leftAligned($Text.fromString(s));
   };
                    ...
                    {case "Fail":
                       ...
                       return function () {
                            ...
                            _L.fromArray([A2($Graphics$Element.spacer,
                                         w,
                                         1)
                                         ,$Text.leftAligned($Text.bold($Text.fromString(_v0._0)))
                                         ,A2($Graphics$Element.spacer,
                                         w$,
                                         1)])));
                         }();}
...
Elm.Main.make = function (_elm) {
   ...
   _P = _N.Ports.make(_elm),
   $moduleName = "Main",
   $Baobab = Elm.Baobab.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $ElmTest$Assertion = Elm.ElmTest.Assertion.make(_elm),
   $ElmTest$Runner$Element = Elm.ElmTest.Runner.Element.make(_elm),
   $ElmTest$Test = Elm.ElmTest.Test.make(_elm),
   $List = Elm.List.make(_elm);
   var assertEqualPaths = F2(function (expected,
   actual) {
      return function () {
         var roundCoords = function (_v0) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
                  return {ctor: "_Tuple2"
                         ,_0: $Basics.round(_v0._0) * 10000
                         ,_1: $Basics.round(_v0._1) * 10000};}
               _U.badCase($moduleName,
               "on line 10, column 30 to 58");
            }();
         };
   ...
   "Baobab function",
   _L.fromArray([$ElmTest$Test.test("given a point and a size, baseless square yields a path")($ElmTest$Assertion.assertEqual(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                            ,_0: 10
                                                                                                                                            ,_1: 0}
                                                                                                                                           ,{ctor: "_Tuple2"
                                                                                                                                            ,_0: 10
                                                                                                                                           ...
                                                                                                                                           ,{ctor: "_Tuple2"
                                                                                                                                            ,_0: 0
                                                                                                                                            ,_1: 0}]))(A2($Baobab.baselessSquare,
                {ctor: "_Tuple2",_0: 0,_1: 0},
                10)))
                ,$ElmTest$Test.test("given a point, a size, and an angle, baseless triangle yields a path")(assertEqualPaths(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                           ,_0: 0
                                                                                                                                           ,_1: 0}
                                                                                                                                          ,{ctor: "_Tuple2"
                                                                                                                                           ,_0: $Basics.sqrt(2)
                                                                                                                                          ...
                                                                                                                                          ,{ctor: "_Tuple2"
                                                                                                                                           ,_0: 2
                                                                                                                                           ,_1: 0}]))(A3($Baobab.baselessTriangle,
                {ctor: "_Tuple2",_0: 0,_1: 0},
                2,
                $Basics.degrees(45))))]));
   var main = $ElmTest$Runner$Element.runDisplay(tests);
   _elm.Main.values = {_op: _op
                      ,assertEqualPaths: assertEqualPaths
                      ,tests: tests
                      ,main: main};
   return _elm.Main.values;
};
